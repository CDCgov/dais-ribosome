...
- `sswsort_res` is now searched for in the same directory as `ribosome_res`, instead of using the current working directory
...
[2.1.1]: https://github.com/CDCgov/dais-ribosome/compare/v2.1.0...v2.1.1
